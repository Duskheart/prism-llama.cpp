...
struct ggml_backend_opencl_context {
    ...
    cl_program program_mul_mat_q1_0_g128_Ab_Bi_8x4;
    ...
    cl_program program_mul_mv_q1_0_f32_1d_16x_flat;
    cl_program program_mul_mv_q1_0_g128_f32_8x_flat;
    cl_program program_mul_mv_q1_0_g128_f32_1d_8x_flat;
    ...
    cl_kernel kernel_convert_block_q1_0_g128, kernel_restore_block_q1_0_g128;
    ...
    cl_kernel kernel_mul_mat_q1_0_f32_1d_8x_flat, kernel_mul_mat_q1_0_f32_1d_16x_flat;
    cl_kernel kernel_mul_mat_q1_0_g128_f32_8x_flat;
    cl_kernel kernel_mul_mat_q1_0_g128_f32_1d_8x_flat;
    ...
    cl_kernel CL_mul_mat_q1_0_g128_Ab_Bi_8x4;
...
static void load_cl_kernels(ggml_backend_opencl_context *backend_ctx, ggml_cl_version opencl_c_version) {
    ...
    // cvt
    {
        ...
        CL_CHECK((backend_ctx->kernel_convert_block_q1_0_g128  = clCreateKernel(backend_ctx->program_cvt, "kernel_convert_block_q1_0_g128", &err), err));
        CL_CHECK((backend_ctx->kernel_restore_block_q1_0_g128  = clCreateKernel(backend_ctx->program_cvt, "kernel_restore_block_q1_0_g128", &err), err));
    ...
    // mul_mv_q1_0_f32_8x_flat (SOA layout, 8 rows per SIMD group)
    {
#ifdef GGML_OPENCL_EMBED_KERNELS
        const std::string kernel_src {
    ...
    // mul_mv_q1_0_g128_f32_8x_flat (SOA layout, token generation)
    {
#ifdef GGML_OPENCL_EMBED_KERNELS
        const std::string kernel_src {
            #include "mul_mv_q1_0_g128_f32_8x_flat.cl.h"
        };
#else
        const std::string kernel_src = read_file("mul_mv_q1_0_g128_f32_8x_flat.cl");
#endif
        backend_ctx->program_mul_mv_q1_0_g128_f32_8x_flat =
            build_program_from_source(backend_ctx->context, backend_ctx->device, kernel_src.c_str(), compile_opts);

        CL_CHECK((backend_ctx->kernel_mul_mat_q1_0_g128_f32_8x_flat = clCreateKernel(backend_ctx->program_mul_mv_q1_0_g128_f32_8x_flat, "kernel_mul_mat_q1_0_g128_f32_8x_flat", &err), err));
        GGML_LOG_CONT(".");
    }

    // mul_mv_q1_0_f32_1d_8x_flat (SOA layout, 1D batched for prompt processing)
    {
#ifdef GGML_OPENCL_EMBED_KERNELS
        const std::string kernel_src {
    ...
    // mul_mv_q1_0_f32_1d_16x_flat (SOA layout, 1D batched for prompt processing - Intel)
    {
#ifdef GGML_OPENCL_EMBED_KERNELS
        const std::string kernel_src {
            #include "mul_mv_q1_0_f32_1d_16x_flat.cl.h"
        };
#else
        const std::string kernel_src = read_file("mul_mv_q1_0_f32_1d_16x_flat.cl");
#endif
        backend_ctx->program_mul_mv_q1_0_f32_1d_16x_flat =
            build_program_from_source(backend_ctx->context, backend_ctx->device, kernel_src.c_str(), compile_opts);

        CL_CHECK((backend_ctx->kernel_mul_mat_q1_0_f32_1d_16x_flat = clCreateKernel(backend_ctx->program_mul_mv_q1_0_f32_1d_16x_flat, "kernel_mul_mat_q1_0_f32_1d_16x_flat", &err), err));
        GGML_LOG_CONT(".");
    }

    // mul_mv_q1_0_g128_f32_1d_8x_flat (SOA layout, batch processing)
    {
#ifdef GGML_OPENCL_EMBED_KERNELS
        const std::string kernel_src {
            #include "mul_mv_q1_0_g128_f32_1d_8x_flat.cl.h"
        };
#else
        const std::string kernel_src = read_file("mul_mv_q1_0_g128_f32_1d_8x_flat.cl");
#endif
        backend_ctx->program_mul_mv_q1_0_g128_f32_1d_8x_flat =
            build_program_from_source(backend_ctx->context, backend_ctx->device, kernel_src.c_str(), compile_opts);

        CL_CHECK((backend_ctx->kernel_mul_mat_q1_0_g128_f32_1d_8x_flat = clCreateKernel(backend_ctx->program_mul_mv_q1_0_g128_f32_1d_8x_flat, "kernel_mul_mat_q1_0_g128_f32_1d_8x_flat", &err), err));
        GGML_LOG_CONT(".");
    }
    ...
    // mul_mat_q1_0_g128_Ab_Bi_8x4 (Q1_0_g128 GEMM kernel)
    {
#ifdef GGML_OPENCL_EMBED_KERNELS
        const std::string kernel_src_q1_0_g128_gemm {
            #include "mul_mat_q1_0_g128_Ab_Bi_8x4.cl.h"
        };
#else
        const std::string kernel_src_q1_0_g128_gemm = read_file("mul_mat_q1_0_g128_Ab_Bi_8x4.cl");
#endif
        backend_ctx->program_mul_mat_q1_0_g128_Ab_Bi_8x4 = build_program_from_source(backend_ctx->context, backend_ctx->device, kernel_src_q1_0_g128_gemm.c_str(), compile_opts);
        CL_CHECK((backend_ctx->CL_mul_mat_q1_0_g128_Ab_Bi_8x4 = clCreateKernel(backend_ctx->program_mul_mat_q1_0_g128_Ab_Bi_8x4, "kernel_mul_mat_q1_0_g128_Ab_Bi_8x4", &err), err));
        GGML_LOG_CONT(".");
    }
...
struct ggml_tensor_extra_cl_q1_0_g128 {
    cl_mem q = nullptr;
    cl_mem q_img = nullptr;
    cl_mem d = nullptr;
    cl_mem d_img = nullptr;
    ...
    ~ggml_tensor_extra_cl_q1_0_g128() {
        reset();
    }
...
#pragma message("TODO: implement BF16, Q4_0, Q4_1, Q5_0, Q5_1, Q8_0, IQ4_NL support (https://github.com/ggml-org/llama.cpp/pull/14661)")
        ...
        case GGML_OP_MUL_MAT:
            if (op->src[0]->type == GGML_TYPE_F16) {
                ...
                return op->src[1]->type == GGML_TYPE_F32;
            } else if (op->src[0]->type == GGML_TYPE_Q1_0 || op->src[0]->type == GGML_TYPE_Q1_0_g128) {
                return op->src[1]->type == GGML_TYPE_F32 && ggml_is_contiguous(op->src[0]) && ggml_is_contiguous(op->src[1]);
            }
            return false;
...
struct ggml_backend_opencl_buffer_context {
    ...
    ~ggml_backend_opencl_buffer_context() {
        ...
        for (ggml_tensor_extra_cl_q1_0_g128 * e : temp_tensor_extras_q1_0_g128) {
            delete e;
        }
        for (ggml_tensor_extra_cl_q1_0_g128 * e : temp_tensor_extras_q1_0_g128_in_use) {
            delete e;
        }
    ...
    ggml_tensor_extra_cl_q1_0_g128 * ggml_opencl_alloc_temp_tensor_extra_q1_0_g128() {
        ggml_tensor_extra_cl_q1_0_g128 * extra;
        if (temp_tensor_extras_q1_0_g128.empty()) {
            extra = new ggml_tensor_extra_cl_q1_0_g128();
        } else {
            extra = temp_tensor_extras_q1_0_g128.back();
            temp_tensor_extras_q1_0_g128.pop_back();
        }

        temp_tensor_extras_q1_0_g128_in_use.push_back(extra);
    ...
    void reset() {
        ...
        for (ggml_tensor_extra_cl_q1_0_g128 * e : temp_tensor_extras_q1_0_g128_in_use) {
            temp_tensor_extras_q1_0_g128.push_back(e);
        }
        temp_tensor_extras_q1_0_g128_in_use.clear();
    ...
    std::vector<ggml_tensor_extra_cl_q1_0_g128 *> temp_tensor_extras_q1_0_g128;
    std::vector<ggml_tensor_extra_cl_q1_0_g128 *> temp_tensor_extras_q1_0_g128_in_use;
...
static void ggml_backend_opencl_buffer_set_tensor(ggml_backend_buffer_t buffer, ggml_tensor * tensor, const void * data, size_t offset, size_t size) {
    ...
    if (tensor->type == GGML_TYPE_Q1_0_g128) {
        ggml_tensor_extra_cl * extra_orig = (ggml_tensor_extra_cl *)tensor->extra;
        GGML_ASSERT(extra_orig && "Tensors in OpenCL backend should have been allocated and initialized");

        ggml_backend_opencl_buffer_context * ctx = (ggml_backend_opencl_buffer_context *) buffer->context;
        ggml_tensor_extra_cl_q1_0_g128 * extra = ctx->ggml_opencl_alloc_temp_tensor_extra_q1_0_g128();
        ...
        extra->d = clCreateSubBuffer(
            ...
            CL_BUFFER_CREATE_TYPE_REGION, &region, &err);
        CL_CHECK(err);
        auto previous_origin_q1g = region.origin;

        region.origin = align_to(previous_origin_q1g + size_d, backend_ctx->alignment);
        region.size = size_q;
        extra->q = clCreateSubBuffer(
            extra_orig->data_device, CL_MEM_READ_WRITE,
            CL_BUFFER_CREATE_TYPE_REGION, &region, &err);
        ...
        cl_kernel kernel = backend_ctx->kernel_convert_block_q1_0_g128;
...
static void ggml_backend_opencl_buffer_get_tensor(ggml_backend_buffer_t buffer, const ggml_tensor * tensor, void * data, size_t offset, size_t size) {
    ...
    if (tensor->type == GGML_TYPE_Q1_0_g128) {
        ggml_tensor_extra_cl_q1_0_g128 * extra = (ggml_tensor_extra_cl_q1_0_g128 *)tensor->extra;
        ...
        cl_kernel kernel = backend_ctx->kernel_restore_block_q1_0_g128;
        CL_CHECK(clSetKernelArg(kernel, 0, sizeof(cl_mem), &extra->q));
        CL_CHECK(clSetKernelArg(kernel, 1, sizeof(cl_mem), &extra->d));
        CL_CHECK(clSetKernelArg(kernel, 2, sizeof(cl_mem), &data_device));
...
static void ggml_cl_mul_mat(ggml_backend_t backend, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    ggml_tensor_extra_cl_q1_0_g128 * extra0_q1_0_g128 = (ggml_tensor_extra_cl_q1_0_g128 *)src0->extra;
    ...
    if(src0t == GGML_TYPE_Q1_0 && src1t == GGML_TYPE_F32 && N > 8) {
        ggml_tensor_extra_cl_q1_0 * extra0_q1_0_typed = (ggml_tensor_extra_cl_q1_0 *)src0->extra;
        ggml_tensor_extra_cl * extra1 = (ggml_tensor_extra_cl *)src1->extra;
        ggml_tensor_extra_cl * extrad = (ggml_tensor_extra_cl *)dst->extra;
        ...
        CL_CHECK(clSetKernelArg(kernel, 0, sizeof(cl_mem), &extra0_q1_0_typed->q));
        CL_CHECK(clSetKernelArg(kernel, 1, sizeof(cl_mem), &extra0_q1_0_typed->d));
        CL_CHECK(clSetKernelArg(kernel, 2, sizeof(cl_mem), &extra1->data_device));
        CL_CHECK(clSetKernelArg(kernel, 3, sizeof(cl_ulong), &offset1));
        CL_CHECK(clSetKernelArg(kernel, 4, sizeof(cl_mem), &extrad->data_device));
        CL_CHECK(clSetKernelArg(kernel, 5, sizeof(cl_ulong), &offsetd));
    ...
    // Q1_0_g128 x FP32 GEMM for batch processing - direct buffer access (no transpose)
    if(src0t == GGML_TYPE_Q1_0_g128 && src1t == GGML_TYPE_F32 && N > 8) {
        cl_kernel kernel = backend_ctx->CL_mul_mat_q1_0_g128_Ab_Bi_8x4;

        size_t global_work_size[3] = {(size_t)((N + 7) / 8), (size_t)(M / 4), 1};
        size_t local_work_size[3] = {1, 128, 1};

        CL_CHECK(clSetKernelArg(kernel, 0, sizeof(cl_mem), &extra0_q1_0_g128->q));
        CL_CHECK(clSetKernelArg(kernel, 1, sizeof(cl_mem), &extra0_q1_0_g128->d));
        CL_CHECK(clSetKernelArg(kernel, 2, sizeof(cl_mem), &extra1->data_device));
        CL_CHECK(clSetKernelArg(kernel, 3, sizeof(cl_ulong), &offset1));
        CL_CHECK(clSetKernelArg(kernel, 4, sizeof(cl_mem), &extrad->data_device));
        CL_CHECK(clSetKernelArg(kernel, 5, sizeof(cl_ulong), &offsetd));
        ...
        switch(src0t) {
            ...
            case GGML_TYPE_Q1_0:
                ...
                if (backend_ctx->gpu_family == INTEL) {
                    nth0 = 16;
                    nth1 = 1;
                    kernel = backend_ctx->kernel_mul_mat_q1_0_f32_1d_16x_flat;
                } else if (backend_ctx->gpu_family == ADRENO) {
                    nth0 = 64;
                    nth1 = 1;
        ...
        case GGML_TYPE_Q1_0_g128:
            {
                ...
                kernel = backend_ctx->kernel_mul_mat_q1_0_g128_f32_8x_flat;
