// Q1_0_g128 GEMM Kernel - Direct GGML layout (no transpose needed)
...
//
// Q1_0_g128: 128 elements per block, 16 bytes (128 bits) + 1 half scale
...
kernel void kernel_mul_mat_q1_0_g128_Ab_Bi_8x4(
    ...
    int num_blocks = k / 128;   // 128 elements per block for g128
    int row_base = gy << 3;     // gy * 8 = starting output row

    // Pointers for 4 weight columns (SOA layout, row-major)
    // For Q1_0_g128: each block is 16 bytes (128 bits)
